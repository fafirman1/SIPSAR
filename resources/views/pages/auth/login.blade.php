                ...
                <div class="col-lg-8 col-12 order-lg-2 min-vh-100 background-walk-y position-relative overlay-gradient-bottom order-1"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="display-4 font-weight-bold mb-2">SMP IT Insan Qur'an Poncowarno</h1>
                                <h5 class="font-weight-normal text-muted-transparent">Sistem Informasi Pengenalan Sekolah Augmented Reality</h5>
                            </div>
